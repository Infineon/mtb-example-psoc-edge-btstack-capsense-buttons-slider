...
The following example clones the "[Bluetooth&reg; LE CAPSENSE&trade; buttons slider](https://github.com/Infineon/mtb-example-psoc-edge-btstack-capsense-buttons-slider)" application with the desired name "ButtonsSlider" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-btstack-capsense-buttons-slider --user-app-name ButtonsSlider --target-dir "C:/mtb_projects"
   ```
